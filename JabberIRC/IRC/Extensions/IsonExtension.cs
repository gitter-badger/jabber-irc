...
namespace JabberIRC.IRC.Extensions
{
    ...
    /// </summary>
    public static class IsonExtension
    {
        public static void Ison(this ApiWrapper apiWrapper, StreamWriter writer, string nickname)
        {
            writer.WriteLine($"ISON {nickname}");
        }

        public static void Ison(this ApiWrapper apiWrapper, StreamWriter writer, List<string> nicknames)
        {
            writer.WriteLine($"ISON {string.Join(" ", nicknames)}");
        }
    }
}
