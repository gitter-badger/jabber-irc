...
namespace JabberIRC.IRC.Extensions
{
    ...
    {
        public static void Stats(this ApiWrapper apiWrapper, StreamWriter writer, string query=null, string target=null)
        {
            string space = query == null ? "" : " ";
            writer.WriteLine($"STATS{space}{query}{space}{target}");
        }
    }
}
